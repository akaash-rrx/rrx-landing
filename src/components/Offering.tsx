...
const Offering = () => {
  return (
    <section id="our-research-stack" className="py-24 px-6 relative overflow-hidden">
      {/* Gradient transition overlay at top of section */}
      ...
      <div className="max-w-7xl mx-auto relative z-20">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          <motion.div
            ...
            className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all hover:translate-y-[-5px]"
          >
